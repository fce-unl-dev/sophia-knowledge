...
- **Nombre oficial**: {Nombre largo y completo, como figura en web FCE}
- **Código corto / sigla**: {MBA / MAF / GFSP / etc., si tiene}
...
**Última revisión humana**: {YYYY-MM-DD}
**Revisado por**: {Nombre o iniciales}
