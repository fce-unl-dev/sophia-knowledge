...
- **Nombre oficial**: Estudiantes
- **Código corto / sigla**: No publicado
- **Tipo**: No aplica - esta página es una categoría de información para alumnos de posgrado, no una propuesta académica.
...
- **Modalidad de pago**: Sistema Mercurio UNL (https://servicios.unl.edu.ar/mdcobro/)
...
**Aulas virtuales:**
- Carreras presenciales: Ingresar al Ambiente Virtual
- Carreras a distancia: Ingresar a UNL Virtual

**E-mails útiles adicionales:**
- Mesa de entrada: mesadeentradas@fce.unl.edu.ar (Envío de notas y seguimiento de expedientes)
- Alumnado: alumnado@fce.unl.edu.ar (Trámites administrativos vinculados a SIU GUARANI POSGRADO)
- Diplomas: diplomas@fce.unl.edu.ar (Trámite de diploma)
- Tesorería: tesoreria@fce.unl.edu.ar (Consultas financieras (pagos cuotas, solicitud facturas))
