...
-   **Nombre oficial**: Especialización en Sindicatura Concursal
...
-   **Modalidad**: Presencial (con clases por videoconferencia) y a distancia (con plataforma Moodle)
-   **Días y horarios de cursada**: Jueves y viernes de 16:30 a 20:30 hs cada 15 días
-   **Lugar**: FCE-UNL, Moreno 2557, Santa Fe (para modalidad presencial con videoconferencia) y 100% online (para modalidad a distancia)
-   **Idioma**: Español
...
**Asignatura 1. Derecho Concursal I** (75 hs)
-   **Objetivos**:
...
**Asignatura 2. Gestión y Auditoría de Empresas en Crisis** (60 hs)
-   **Objetivos**:
...
**Asignatura 3. Derecho Procesal** (45 hs)
-   **Objetivos**:
...
**Asignatura 4. Práctica Concursal I** (60 hs)
-   **Objetivos**:
...
**Asignatura 5. Derecho Concursal II** (75 hs)
-   **Objetivos**:
...
**Asignatura 6. Práctica Concursal II** (60 hs)
-   **Objetivos**:
...
**Asignatura 7. Taller de Trabajo Final** (30 hs)
-   **Objetivos**:
...
### Trabajo final / tesis
Trabajo Final Integrador individual. El plazo para su presentación y aprobación es de hasta 3 años desde la inscripción a la carrera. Luego de aceptado, requiere defensa oral para aprobación definitiva.
...
-   **Cursado y promoción**: Se ofrecen dos modalidades:
    -   **Modalidad presencial (con clases por videoconferencia)**: Se requiere asistencia a un mínimo del 75% de las horas de dictado efectivo de clases (teóricas y prácticas). Las horas no presenciales se complementan con trabajos bibliográficos y de estudio a través del aula virtual. La evaluación incluye exámenes finales orales (para materias teóricas) y escritos (para exámenes prácticos).
    -   **Modalidad a distancia**: El dictado permite al estudiante administrar sus tiempos de lectura, análisis de material multimedia y realización de actividades. Se utiliza la plataforma Moodle y diversas herramientas tecnológicas. La evaluación se realiza de forma online.
    En ambas modalidades, al aprobar todas las asignaturas se realiza un trabajo final integrador.
-   **Comité Académico**:
    -   Dr. Lucila Prono (Directora)
    -   Mg. Marcela Martin (Secretaria de Posgrado)
    -   Mg. Andrea Pacífico (Representante Decanato)
    -   Esp. Waldo Raúl Finos (Director del Departamento de Contabilidad e Impuestos)
    -   Dra. María Cristina de Césaris (Docente)
    -   Esp. María Emilia Degrave Monteferrario (Graduada)
