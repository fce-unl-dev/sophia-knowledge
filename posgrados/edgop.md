...
- Economía Gubernamental (30 hs / 2 UCAs)
- Análisis Institucional de Organizaciones Públicas (45 hs / 3 UCAs)
- Planificación y Rendición de Cuentas por Resultados (45 hs / 3 UCAs)
- Evaluación de Resultados e Impactos de Organizaciones y Programas Públicos (45 hs / 3 UCAs)
- Conducción y Gerencia en Instituciones Públicas (30 hs / 2 UCAs)
...
| IACOVELLO | Mercedes Beatriz | SAN ANDRES |
| LUGO | Ariel | UNL |
| MARTIN | Carlos | UNL |
| MILLER | Ezequiel Albero | UNR |
| MIRANDA | Juan José | Universidad Pontificia (Colombia) |
...
- **Becas disponibles**: Convenio Específico de colaboración entre la Universidad Nacional del Litoral y la Unión del Personal Civil de la Nación-Seccional Santa Fe, por el que se otorga un descuento del 20% (Veinte por ciento) sobre el costo total de la Carrera a todos/as los/as profesionales que la entidad gremial informe a las autoridades de la EDGOP- Especialización en Dirección y Gestión de Organizaciones Públicas y a las autoridades de la Facultad de Ciencias Económicas de la UNL.
...
- **Última actualización del dato**: 2026-09-07

> Nota: Si la fecha indicada ya pasó respecto a la fecha actual, Sophia debe declararlo explícitamente y derivar al contacto oficial para confirmar la próxima cohorte.

## Contacto

- **Director/a académico/a**: Mg. Mejias Nestor Dario
- **Codirector académico**: Lic. Hintze, Jorge Orlando
