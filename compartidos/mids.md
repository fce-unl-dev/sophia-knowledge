# Maestría en Innovación para el Desarrollo Sostenible

La Maestría en Innovación para el Desarrollo Sostenible (MIDS) se fundamenta en un paradigma integrador e interdisciplinario, articulando economía, administración, ingeniería, ciencias sociales y ambientales. Persigue como propósito formar profesionales capaces de liderar procesos de transformación territorial mediante enfoques integrados de innovación, equidad y sostenibilidad, promoviendo el compromiso del sector académico en la generación de conocimiento y el acompañamiento al desarrollo sostenible. Desde una mirada crítica e innovadora, la Maestría se alinea con los principios de la Agenda 2030 para el Desarrollo Sostenible, y se propone construir capacidades para la acción transformadora mediante metodologías activas, enfoques sistémicos, y un fuerte énfasis en la contextualización territorial.

---

## Identificación

- **Nombre oficial**: Maestría en Innovación para el Desarrollo Sostenible
- **Código corto / sigla**: MIDS
- **Tipo**: Maestría
- **Título que otorga**: Magíster en Innovación para el Desarrollo Sostenible
- **Acreditación CONEAU**: No publicado en fuentes oficiales — consultar con Secretaría de Posgrado
- **Unidad académica**: FCE-UNL
- **Carreras compartidas con otras unidades**: Facultad de Ciencias Exactas, Físicas y Naturales (FCEFyN-UNC)

## Modalidad y duración

- **Modalidad**: Presencial
- **Días y horarios de cursada**: A definir previo al inicio de cohorte.
- **Lugar**: FCE-UNL (Santa Fe) y FCEFyN-UNC (Córdoba).
- **Idioma**: Español
- **Duración cursada**: 4 cuatrimestres
- **Duración trabajo final / tesis**: Hasta 2 años a partir de la admisión a la carrera.
- **Carga horaria total**: 930 horas / 62 UCAs

## Plan de estudios

### Estructura general
La Maestría se estructura en 4 módulos temáticos, un módulo de asignaturas optativas y un Trabajo Final de Maestría. El cursado tiene una carga horaria total de 780 horas (52 UCAs) y el Trabajo Final de Maestría suma 150 horas (10 UCAs), totalizando 930 horas y 62 UCAs.
...
- **Email del programa**: No publicado en fuentes oficiales — consultar con Secretaría de Posgrado
...
**Marco Internacional**: Desarrollada en el marco del proyecto USGAT (Unleashing Sustainable Growth through Applied Technologies), financiado por el Programa Erasmus+ (CBHE) de la Unión Europea, con la participación de 7 universidades de América Latina (Colombia, Ecuador y Perú) y 3 universidades europeas (España e Italia).

**Objetivos**:
- **Objetivo General**: Formar profesionales capaces de liderar procesos de transformación territorial mediante enfoques integrados de innovación, equidad y sostenibilidad.
- **Objetivos Específicos**:
    - Promover una formación avanzada, crítica y situada sobre los desafíos contemporáneos del desarrollo sostenible.
    - Fortalecer las capacidades para el diseño, gestión y evaluación de políticas, programas y proyectos alineados con los ODS.
    - Formar profesionales capaces de integrar enfoques cuantitativos y cualitativos mediante herramientas tecnológicas avanzadas.
    - Fomentar la articulación entre el conocimiento científico y la práctica socio-productiva.
    - Incentivar la producción de conocimiento aplicado para generar soluciones innovadoras y contextualizadas.

**Perfil del egresado**: El graduado poseerá competencias para:
- Diagnosticar problemáticas complejas del desarrollo regional integrando dimensiones sociales, económicas, ambientales y tecnológicas.
- Diseñar y liderar proyectos de innovación social, económica y tecnológica con impacto territorial.
- Formular políticas y estrategias organizacionales con criterios de sostenibilidad, responsabilidad social y equidad.
- Utilizar herramientas de análisis de datos, sistemas de información geográfica (SIG) y métodos de evaluación de impacto para la toma de decisiones.
- Desempeñarse en el sector público, privado, ONG, organismos internacionales y ámbito académico.
...
- https://www.fce.unl.edu.ar/sitios/mids/index.php?act=showSubcategoria&id=324 (Días y horarios de cursado)
